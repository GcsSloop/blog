...
![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-072323.png?gcssloop)

### 2.在搜索框输入plantUML
![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-072324.png?gcssloop)

### 3.导入插件

#### (ps：由于我已经安装过了，所以没有Install plugin 按钮，未安装的都有这样一个按钮，如下，点击安装即可。)

![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-072325.png?gcssloop)

#### 如果以上步骤正确的完成，重启AndroidStudio 右键->new 的时候你会发现多了这么一堆东西，如果出现了这些说明plantUML已经正确的安装了。

![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-072326.png?gcssloop)

#### 当然了，所有事情都不会是一帆风顺的，当你迫不及待的想创建一个文件试试的时候你会发现下面的情况。

![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-072327.png?gcssloop)
...
![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-72328.png?gcssloop)

### 2.安装

#### 安装过程我就不详细讲解了，点击next后要记住安装的目录。之后下一步，直到完成就行。

![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-072329.png?gcssloop)
...
![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-072330.png?gcssloop)

### 3.点击OK 刷新一下界面就能看到这个了。

![这里写图片描述](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-72331.png?gcssloop)
