...
layout: post
category: CustomView
title: 安卓自定义View进阶-手势检测(GestureDetector)
...
![](http://gcsblog.oss-cn-shanghai.aliyuncs.com/blog/2019-04-29-071623.gif?gcssloop)
...
根据这三条基本的逻辑就可以做出比较像的弹球效果，[具体的Demo可以看这里](https://github.com/GcsSloop/AndroidNote/blob/master/CustomView/Demo/FailingBall.zip)。
