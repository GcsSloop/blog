...
layout: post
category: CustomView
title: 安卓自定义View进阶-缩放手势检测(ScaleGestureDecetor)
tags: Android,ScaleGestureDecetor
keywords: ScaleGestureDecetor, 自定义View详解, 自定义控件, 安卓, Android, CustomView, GcsSloop
excerpt: Android 手势检测，主要是 ScaleGestureDecetor 相关内容的用法和注意事项，本文依旧属于事件处理这一体系，部分内容会涉及到之前文章提及过的知识点，如果你没看过之前的文章，可以到自定义View系列来查看这些内容。
...
![demo-3656658](/assets/customview/scale-gesture-decetor/demo.gif)
